...
?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <img class="img-responsive" src="img/aeroclub.jpg" alt="">
            </div>
        </div>
        <!-- /.row -->
       ...
       <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header">Services de base</h2>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header">Liste des services</h2>
            </div>
            <div class="col-md-4">
                <div class="media">
                    <div class="pull-left">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Parachutisme</h4>
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Baptême de l'air</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo itaque ipsum sit harum.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Leçons de pilotage</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo itaque ipsum sit harum.</p>
                    </div>
                </div>
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Stationnement</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo itaque ipsum sit harum.</p>
                    </div>
                </div>
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Avitaillement</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo itaque ipsum sit harum.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Nettoyage intérieur</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo itaque ipsum sit harum.</p>
                    </div>
                </div>
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Informations météorologiques</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo itaque ipsum sit harum.</p>
                    </div>
                </div>
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Respect de l'environemment</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo itaque ipsum sit harum.</p>
                    </div>
                </div>
            </div>
